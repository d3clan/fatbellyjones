  ...
  $.mbExtruder= {
    ...
    buildMbExtruder: function(options){
      return this.each (function (){
        ...
        var c= $("<div/>").addClass("content").css({overflowY:"auto", overflowX:"hidden", width:extW});
        ...
        if (extruder.attr("extUrl")){
          ...
          var container=$("<div>").addClass("text").css({width:extruder.get(0).options.width-20, height:extruder.height()-20, overflowX:"hidden",overflowY:"auto"});
    ...
    openMbExtruder:function(c){
      ...
      if (position=="top" || position=="bottom"){
        ...
        extruder.find('.content').css({overflowX:"hidden",overflowY:"auto", display:"block"});
    ...
    closeMbExtruder:function(){
      ...
      if (opt.position=="top" || opt.position=="bottom"){
        ...
        extruder.find('.content').css({overflowX:"hidden",overflowY:"auto"});
        extruder.find('.content').animate({ width: 1 }, opt.slideTimer,function(){
          extruder.find('.ext_wrapper').css({width:1});
          extruder.find('.content').css({overflowX:"hidden",overflowY:"auto",display:"none"});
          if(opt.onExtClose) opt.onExtClose();
        });
      }
    }
